...
PRODUCT_NAME              = mcb_pmsm_foc_I2C_f28379d
MAKEFILE                  = mcb_pmsm_foc_I2C_f28379d.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_I2C_f28379d.out
...
%.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
ert_main.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_I2C_f28379d.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/mcb_pmsm_foc_I2C_f28379d.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_I2C_f28379d_data.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/mcb_pmsm_foc_I2C_f28379d_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/mcb_pmsm_foc_I2C_f28379d_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
