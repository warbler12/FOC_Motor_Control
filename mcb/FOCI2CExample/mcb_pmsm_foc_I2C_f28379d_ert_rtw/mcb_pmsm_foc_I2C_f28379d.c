...
static void rate_monotonic_scheduler(void)
{
  ...
  if ((mcb_pmsm_foc_I2C_f28379d_M->Timing.TaskCounters.TID[3]) > 999) {/* Sample time: [0.5s, 0.0s] */
...
void mcb_pmsm_foc_CurrentControl(void)
{
  ...
  mcb_pmsm_foc_I2C_f28379d_B.Lookup[0] =
    mcb_pmsm_foc_I2C_f28379d_ConstP.pooled6[(int16_T)Sum];
  ...
  mcb_pmsm_foc_I2C_f28379d_B.TmpSignalConversionAtSelectorIn[11] =
    mcb_pmsm_foc_I2C_f28379d_B.RT15;
  mcb_pmsm_foc_I2C_f28379d_B.TmpSignalConversionAtSelectorIn[12] =
    mcb_pmsm_foc_I2C_f28379d_B.TmpRTBAtSpeedControlOutport3;
  ...
  switch (mcb_pmsm_foc_I2C_f28379d_B.DataStoreRead) {
   ...
   default:
     ...
     */
    mcb_pmsm_foc_I2C_f28379d_B.MultiportSwitch[0] = 12U;
    mcb_pmsm_foc_I2C_f28379d_B.MultiportSwitch[1] = 13U;
    break;
  }
  ...
  s202_iter = 1;
  do {
    mcb_pmsm_foc_I2C_f28379d_B.WhileIterator = s202_iter;
  ...
  if (mcb_pmsm_foc_I2C_f28379d_B.Sum_a > 0.5F) {
     ...
     *  Fcn: '<S179>/Fcn'
     */
    mcb_pmsm_foc_I2C_f28379d_B.Merge_c = mcb_pmsm_foc_I2C_f28379d_B.Sum_a - 1.0F;
...
void mcb_pmsm_foc_I_SpeedControl(const boolean_T *rtd_Enable,
...
void mcb_pmsm_foc_I2C_f28379d_step0(void) /* Sample time: [0.0005s, 0.0s] */
{
  ...
  mcb_pmsm_foc_I2C_f28379d_B.RT14 =
    mcb_pmsm_foc_I2C_f28379d_DW.RT14_Buffer[mcb_pmsm_foc_I2C_f28379d_DW.RT14_ActiveBufIdx];

  /* Outputs for Atomic SubSystem: '<Root>/Speed Control' */
  mcb_pmsm_foc_I_SpeedControl(&mcb_pmsm_foc_I2C_f28379d_DW.Enable,
    &mcb_pmsm_foc_I2C_f28379d_B.SpeedControl);

  /* End of Outputs for SubSystem: '<Root>/Speed Control' */

  /* RateTransition: '<Root>/RT15' */
  mcb_pmsm_foc_I2C_f28379d_DW.RT15_Buffer[mcb_pmsm_foc_I2C_f28379d_DW.RT15_ActiveBufIdx
    == 0] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.RT15_ActiveBufIdx =
    (mcb_pmsm_foc_I2C_f28379d_DW.RT15_ActiveBufIdx == 0);
  ...
  mcb_pmsm_foc_I2C_f28379d_DW.RT2_Buffer[1 +
    ((mcb_pmsm_foc_I2C_f28379d_DW.RT2_ActiveBufIdx == 0) << 1U)] =
    mcb_pmsm_foc_I2C_f28379d_B.SpeedControl.Constant2;
  mcb_pmsm_foc_I2C_f28379d_DW.RT2_ActiveBufIdx =
    (mcb_pmsm_foc_I2C_f28379d_DW.RT2_ActiveBufIdx == 0);

  /* RateTransition: '<Root>/RT7' */
  mcb_pmsm_foc_I2C_f28379d_B.RT7 = mcb_pmsm_foc_I2C_f28379d_B.Gain;

  /* RateTransition generated from: '<Root>/Speed Control' */
  mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Bu[mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Ac
    == 0] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Ac =
    (mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Ac == 0);
}
...
void mcb_pmsm_foc_I2C_f28379d_step3(void) /* Sample time: [0.5s, 0.0s] */
{
...
void mcb_pmsm_foc_I2C_f28379d_initialize(void)
{
...

  {
    ...
    mcb_pmsm_foc_I2C_f28379d_B.SpeedControl.Constant2 = 0.0F;
  ...
  mcb_pmsm_foc_I2C_f28379d_DW.ERR = 0.0;
  mcb_pmsm_foc_I2C_f28379d_DW.EnClosedLoop = 0.0;
  ...
  mcb_pmsm_foc_I2C_f28379d_DW.RT14_Buffer[0] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.RT14_Buffer[1] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.RT15_Buffer[0] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.RT15_Buffer[1] = 0.0F;
  ...
  mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Bu[0] = 0.0F;
  mcb_pmsm_foc_I2C_f28379d_DW.TmpRTBAtSpeedControlOutport3_Bu[1] = 0.0F;
  ...
  if (1 == runModel) {
    {
      ...
      /* RateTransition: '<Root>/RT14' */
      mcb_pmsm_foc_I2C_f28379d_DW.RT14_Buffer[mcb_pmsm_foc_I2C_f28379d_DW.RT14_ActiveBufIdx
        == 0] = mcb_pmsm_foc_I2C_f28379d_B.SCIReceive[0];
      mcb_pmsm_foc_I2C_f28379d_DW.RT14_ActiveBufIdx =
        (mcb_pmsm_foc_I2C_f28379d_DW.RT14_ActiveBufIdx == 0);
    }
  }
