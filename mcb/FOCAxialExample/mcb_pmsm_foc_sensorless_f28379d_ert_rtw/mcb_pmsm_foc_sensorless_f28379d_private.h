...
extern void mcb_pmsm_foc_sens_Dir_Sense(boolean_T rtu_A, boolean_T rtu_B,
  ...
  *localZCE);
extern void mcb_pmsm_foc_sen_Subsystem2(real_T rtu_SigmaAlpha, real_T
  rtu_SigmaBeta, real_T *rty_Out1, real_T *rty_Out2);
extern void mcb_pmsm_foc_sensorle_atan2(real_T rtu_A, real_T rtu_B, uint16_T
