###########################################################################
## Makefile generated for component 'mcb_pmsm_foc_test_f28379d'. 
## 
## Makefile     : mcb_pmsm_foc_test_f28379d.mk
## Generated on : Wed Dec 03 16:05:42 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_test_f28379d.out
...
PRODUCT_NAME              = mcb_pmsm_foc_test_f28379d
MAKEFILE                  = mcb_pmsm_foc_test_f28379d.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_foc_test_f28379d.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/C2000W~2/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1 -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/headers/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common -IC:/TI/C2000W~2/LIBRAR~1/math/IQmath/c28/include -IC:/TI/C2000W~2/LIBRAR~1/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_STANDARD = -DMODEL=mcb_pmsm_foc_test_f28379d -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_i2c.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/MW_c28xx_i2c.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_test_f28379d.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/mcb_pmsm_foc_test_f28379d.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_foc_test_f28379d_data.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/mcb_pmsm_foc_test_f28379d_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/mcb_pmsm_foc_test_f28379d_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
