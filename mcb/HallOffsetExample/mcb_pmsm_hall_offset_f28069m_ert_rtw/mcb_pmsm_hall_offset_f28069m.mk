###########################################################################
## Makefile generated for component 'mcb_pmsm_hall_offset_f28069m'. 
## 
## Makefile     : mcb_pmsm_hall_offset_f28069m.mk
## Generated on : Sat Oct 11 16:31:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_hall_offset_f28069m.out
...
PRODUCT_NAME              = mcb_pmsm_hall_offset_f28069m
MAKEFILE                  = mcb_pmsm_hall_offset_f28069m.mk
MATLAB_ROOT               = D:/Software/MATLAB
MATLAB_BIN                = D:/Software/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/13571/Documents/MATLAB/Examples/R2023b/mcb/HallOffsetExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mcb_pmsm_hall_offset_f28069m.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~1/include -IC:/TI/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~4/include -IC:/TI/CONTRO~1//libs/math/CLAmath/v400/include -IC:/TI/CONTRO~1//libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/TI/CONTRO~1//libs/UTILIT~1/HRCAP_~1/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
DEFINES_SKIPFORSIL = -DMW_SCHEDULER_PRIORITY=2 -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=4 -DMW_F2806X -DSTACK_SIZE=64 -DRT -DF28069M -DCPU1 -DBOOT_FROM_FLASH=1 -DMW_FAST_RTS_INCLUDED=0 -DMW_HCCAL_INCLUDED=0
DEFINES_STANDARD = -DMODEL=mcb_pmsm_hall_offset_f28069m -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_cap.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/MW_c28xx_cap.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_hall_offset_f28069m.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/mcb_pmsm_hall_offset_f28069m.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


mcb_pmsm_hall_offset_f28069m_data.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/mcb_pmsm_hall_offset_f28069m_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/mcb_pmsm_hall_offset_f28069m_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
