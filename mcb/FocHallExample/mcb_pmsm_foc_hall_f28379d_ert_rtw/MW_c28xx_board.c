...
void init_board (void)
{
  ...
  /* Assign used eCAP modules to CPU1 */
  DevCfgRegs.CPUSEL1.bit.ECAP1 = 0U;
  DevCfgRegs.CPUSEL1.bit.ECAP2 = 0U;
  DevCfgRegs.CPUSEL1.bit.ECAP3 = 0U;
  ...
  GpioCtrlRegs.GPBQSEL2.all = 0x45000U;
  ...
  // GpioCtrlRegs.GPBCTRL.bit.QUALPRD2 = 0U;      // GPIO Port B Qualification Control Register Field: Sampling period for pins GPIO48 to GPIO 55
  // GpioCtrlRegs.GPBCTRL.bit.QUALPRD3 = 0U;      // GPIO Port B Qualification Control Register Field: Sampling period for pins GPIO56 to GPIO 63
  GpioCtrlRegs.GPBCTRL.all = (GpioCtrlRegs.GPBCTRL.all & ~0xFFFF0000U) | 0x0U;
  EDIS;
