###########################################################################
## Makefile generated for component 'soc_pmsm_cpu1_ref'. 
## 
## Makefile     : soc_pmsm_cpu1_ref.mk
## Generated on : Fri Dec 12 11:44:08 2025
## Final product: ./soc_pmsm_cpu1_ref_rtwlib.lib
...
PRODUCT_NAME              = soc_pmsm_cpu1_ref
MAKEFILE                  = soc_pmsm_cpu1_ref.mk
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = soc_pmsm_cpu1_ref_rtwlib.lib
...
PRODUCT = ./soc_pmsm_cpu1_ref_rtwlib.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/shared/soc/processor/include -I$(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/C2000W~2/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1 -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/headers/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common -IC:/TI/C2000W~2/LIBRAR~1/math/IQmath/c28/include -IC:/TI/C2000W~2/LIBRAR~1/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_ = -DIPC_BLOCK_INCLUDED=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D__TIDELFINOF28379DLAUNCHPAD__=1
...
DEFINES_STANDARD = -DMODEL=soc_pmsm_cpu1_ref -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/MW_c28xx_csl.c $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/MW_c28xx_board.c $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/soc_pmsm_cpu1_ref.c $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/soc_pmsm_cpu1_ref_data.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj soc_pmsm_cpu1_ref.obj soc_pmsm_cpu1_ref_data.obj
...
%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_cpu1_ref.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/soc_pmsm_cpu1_ref.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_cpu1_ref_data.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu1_ref/soc_pmsm_cpu1_ref_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
