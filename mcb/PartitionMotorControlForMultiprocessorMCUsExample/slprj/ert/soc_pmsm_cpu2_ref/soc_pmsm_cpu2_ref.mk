###########################################################################
## Makefile generated for component 'soc_pmsm_cpu2_ref'. 
## 
## Makefile     : soc_pmsm_cpu2_ref.mk
## Generated on : Fri Dec 12 11:44:51 2025
## Final product: ./soc_pmsm_cpu2_ref_rtwlib.lib
...
PRODUCT_NAME              = soc_pmsm_cpu2_ref
MAKEFILE                  = soc_pmsm_cpu2_ref.mk
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = soc_pmsm_cpu2_ref_rtwlib.lib
...
PRODUCT = ./soc_pmsm_cpu2_ref_rtwlib.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/shared/soc/processor/include -I$(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/C2000W~2/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1 -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/headers/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common -IC:/TI/C2000W~2/LIBRAR~1/math/IQmath/c28/include -IC:/TI/C2000W~2/LIBRAR~1/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_ = -DADC_BLOCK_INCLUDED=1 -DIPC_BLOCK_INCLUDED=1 -DPWM_BLOCK_INCLUDED=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D__TIDELFINOF28379DLAUNCHPAD__=1
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0
DEFINES_SKIPFORSIL = -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DSTACK_SIZE=1024 -DRT -DF28379D -DCPU2 -DBOOT_FROM_FLASH=1 -DCPU_RAMLS_PROG_START=0x8000 -DCPU_RAMLS_PROG_LENGTH=0x1800 -DCLA_RAMLS_PROG_START=0xA000 -DCLA_RAMLS_PROG_LENGTH=0x1000 -DCLA_RAMLS_DATA_START=0x9800 -DCLA_RAMLS_DATA_LENGTH=0x800
DEFINES_STANDARD = -DMODEL=soc_pmsm_cpu2_ref -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/MW_c28xx_csl.c $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/MW_c28xx_board.c $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref.c $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref_data.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj soc_pmsm_cpu2_ref.obj soc_pmsm_cpu2_ref_data.obj
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define F28379D --define CPU2 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0 --define CPU_RAMLS_PROG_START=0x8000 --define CPU_RAMLS_PROG_LENGTH=0x1800 --define CLA_RAMLS_PROG_START=0xA000 --define CLA_RAMLS_PROG_LENGTH=0x1000 --define CLA_RAMLS_DATA_START=0x9800 --define CLA_RAMLS_DATA_LENGTH=0x800
...
%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_cpu2_ref.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_cpu2_ref_data.obj : $(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
