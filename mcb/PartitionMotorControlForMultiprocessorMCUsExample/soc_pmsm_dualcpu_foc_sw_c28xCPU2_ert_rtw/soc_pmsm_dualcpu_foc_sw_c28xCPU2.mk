###########################################################################
## Makefile generated for component 'soc_pmsm_dualcpu_foc_sw_c28xCPU2'. 
## 
## Makefile     : soc_pmsm_dualcpu_foc_sw_c28xCPU2.mk
## Generated on : Fri Dec 12 11:45:03 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2.out
...
PRODUCT_NAME              = soc_pmsm_dualcpu_foc_sw_c28xCPU2
MAKEFILE                  = soc_pmsm_dualcpu_foc_sw_c28xCPU2.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2.out
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/toolbox/shared/soc/processor/include -I$(START_DIR)/slprj/ert/soc_pmsm_cpu2_ref -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/C2000W~2/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1 -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/headers/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common -IC:/TI/C2000W~2/LIBRAR~1/math/IQmath/c28/include -IC:/TI/C2000W~2/LIBRAR~1/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_SKIPFORSIL = -DMW_SCHEDULER_PRIORITY=1 -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DSTACK_SIZE=1024 -DRT -DF28379D -DCPU2 -DBOOT_FROM_FLASH=1 -DCPU_RAMLS_PROG_START=0x8000 -DCPU_RAMLS_PROG_LENGTH=0x1800 -DCLA_RAMLS_PROG_START=0xA000 -DCLA_RAMLS_PROG_LENGTH=0x1000 -DCLA_RAMLS_DATA_START=0x9800 -DCLA_RAMLS_DATA_LENGTH=0x800 -DCPU1_CPU2_IPC -DTIC2000_SOC_BASEPRODUCT
DEFINES_STANDARD = -DMODEL=soc_pmsm_dualcpu_foc_sw_c28xCPU2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/MW_c2000ISR.c $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/MW_c28xx_csl.c $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2.c $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_data.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/sysctl.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/c2837xDBoard_Realtime_Support.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGlobalInterrupts.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2837xDInit.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/dma.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_CpuTimers.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_DefaultISR.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/headers/source/F2837xD_GlobalVariableDefs.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_PieCtrl.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_PieVect.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_SysCtrl.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_usDelay.asm C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_CodeStartBranch.asm C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Dma.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Adc.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Gpio.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Ipc_Driver_Lite.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGPIO.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/clb.c C:/TI/C2000Ware_3_04_00_00/libraries/dsp/FPU/c28/source/fpu32/utility/memcpy_fast.asm $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/c2837xDSchedulerTimer0.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/mw_soc_c2000_ipc.c $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ADC_data.c $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_PWM_data.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/MW_c28xADC.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/MW_c28xePWM.c

MAIN_SRC = $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/ert_main.c
...
OBJS = MW_c2000ISR.obj MW_c28xx_csl.obj soc_pmsm_dualcpu_foc_sw_c28xCPU2.obj soc_pmsm_dualcpu_foc_sw_c28xCPU2_data.obj sysctl.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj c2837xDInit.obj dma.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2000HardwareTimerConfig.obj MW_c28xGPIO.obj clb.obj memcpy_fast.obj c2837xDSchedulerTimer0.obj mw_soc_c2000_ipc.obj soc_pmsm_dualcpu_foc_sw_c28xCPU2_ADC_data.obj soc_pmsm_dualcpu_foc_sw_c28xCPU2_PWM_data.obj MW_c28xADC.obj MW_c28xePWM.obj
...
MODELREF_LIBS = ../slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/_sharedutils/rtwshared.lib C:/TI/C2000Ware_3_04_00_00/libraries/math/IQmath/c28/lib/IQmath_fpu32.lib $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/c2837xDPeripherals.cmd $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c28377D.cmd
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) --output_file=$(PRODUCT) $(OBJS) $(MAIN_OBJ) ../slprj/ert/soc_pmsm_cpu2_ref/soc_pmsm_cpu2_ref_rtwlib.lib $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_dualcpu_foc_sw_c28xCPU2.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_dualcpu_foc_sw_c28xCPU2_data.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
soc_pmsm_dualcpu_foc_sw_c28xCPU2_ADC_data.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ADC_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


soc_pmsm_dualcpu_foc_sw_c28xCPU2_PWM_data.obj : $(START_DIR)/soc_pmsm_dualcpu_foc_sw_c28xCPU2_ert_rtw/soc_pmsm_dualcpu_foc_sw_c28xCPU2_PWM_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xADC.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/MW_c28xADC.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xePWM.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/MW_c28xePWM.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
