###########################################################################
## Makefile generated for component 'c28x_i2c_sensor'. 
## 
## Makefile     : c28x_i2c_sensor.mk
## Generated on : Fri Nov 07 14:46:57 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/c28x_i2c_sensor.out
...
PRODUCT_NAME              = c28x_i2c_sensor
MAKEFILE                  = c28x_i2c_sensor.mk
MATLAB_ROOT               = D:/Software/MATLAB
MATLAB_BIN                = D:/Software/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/project/internship/mcb/c28x_i2c_sensor
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/c28x_i2c_sensor.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/c28x_i2c_sensor_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/TI/C2000W~2/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1 -IC:/TI/C2000W~2/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/headers/include -IC:/TI/C2000W~2/DEVICE~1/f2837xd/common -IC:/TI/C2000W~2/LIBRAR~1/math/IQmath/c28/include -IC:/TI/C2000W~2/LIBRAR~1/math/CLAmath/c28/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc
...
DEFINES_ = -DXCP_ADDRESS_GRANULARITY=XCP_ADDRESS_GRANULARITY_BYTE -DXCP_HARDWARE_ADDRESS_GRANULARITY=XCP_ADDRESS_GRANULARITY_WORD -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DXCP_ON_CAN -DXCP_CAN_ID_MASTER=2 -DXCP_CAN_ID_SLAVE=3 -DXCP_CAN_BAUDRATE=1000000 -DXCP_CAN_SJW=2 -DXCP_CAN_SAMPLE_RATE=SINGLE -DXCP_CAN_SYNC_EDGE=SINGLE
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_EXTMODE_SIMULATION_TIME_IN_TICKS -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=840 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=56 -DXCP_MEM_BLOCK_3_NUMBER=15 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1082 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER -DXCP_MIN_EVENT_NO_RESERVED_POOL -DXCP_MAX_CTO_SIZE=8 -DXCP_MAX_DTO_SIZE=8 -DXCP_MAX_ODT_ENTRY_SIZE=7 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=10000 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=c28x_i2c_sensor -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_csl.c $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_board.c $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_i2c.c $(START_DIR)/c28x_i2c_sensor_ert_rtw/c28x_i2c_sensor.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_can.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_can.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/sysctl.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/c2837xDBoard_Realtime_Support.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGlobalInterrupts.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2837xDInit.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/dma.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_CpuTimers.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_DefaultISR.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/headers/source/F2837xD_GlobalVariableDefs.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_PieCtrl.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_PieVect.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_SysCtrl.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_usDelay.asm C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_CodeStartBranch.asm C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Dma.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Adc.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Gpio.c C:/TI/C2000Ware_3_04_00_00/device_support/f2837xd/common/source/F2837xD_Ipc_Driver_Lite.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGPIO.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/clb.c C:/TI/C2000Ware_3_04_00_00/libraries/dsp/FPU/c28/source/fpu32/utility/memcpy_fast.asm $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/c2837xDSchedulerTimer0.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/rtiostream_can_c28x_ext_xcp.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/can.c C:/TI/C2000Ware_3_04_00_00/driverlib/f2837xd/driverlib/interrupt.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2000HardwareTimerSupport.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/mw_soc_c2000_ipc.c

MAIN_SRC = $(START_DIR)/c28x_i2c_sensor_ert_rtw/ert_main.c
...
OBJS = xcp_ext_mode.obj MW_c28xx_csl.obj MW_c28xx_board.obj MW_c28xx_i2c.obj c28x_i2c_sensor.obj xcp_ext_common.obj xcp_ext_classic_trigger.obj xcp.obj xcp_standard.obj xcp_daq.obj xcp_calibration.obj xcp_fifo.obj xcp_transport.obj xcp_mem_default.obj xcp_drv_rtiostream.obj xcp_utils.obj xcp_frame_can.obj xcp_ext_param_default_can.obj sysctl.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj c2837xDInit.obj dma.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2000HardwareTimerConfig.obj MW_c28xGPIO.obj clb.obj memcpy_fast.obj c2837xDSchedulerTimer0.obj rtiostream_can_c28x_ext_xcp.obj can.obj interrupt.obj c2000HardwareTimerSupport.obj mw_soc_c2000_ipc.obj
...
%.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_i2c.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/MW_c28xx_i2c.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


c28x_i2c_sensor.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/c28x_i2c_sensor.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/c28x_i2c_sensor_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
xcp_frame_can.obj : $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_can.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


xcp_ext_param_default_can.obj : $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_can.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
rtiostream_can_c28x_ext_xcp.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/rtiostream_can_c28x_ext_xcp.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
