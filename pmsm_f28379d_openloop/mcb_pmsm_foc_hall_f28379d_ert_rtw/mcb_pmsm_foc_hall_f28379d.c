...
void mcb_pms_CurrentControl_Init(void)
{
  ...
  mcb_pmsm_foc_hall_f28379d_DWork.DelayOneStep_DSTATE = 2500U;
...
void mcb_pmsm_foc_CurrentControl(void)
{
  ...
  mcb_pmsm_foc_hall_f28379d_B.Compare_e =
    (mcb_pmsm_foc_hall_f28379d_B.DataStoreRead2 >= 36523UL);
  ...
  if (mcb_pmsm_foc_hall_f28379d_B.Compare_n) {
    ...
    if (mcb_pmsm_foc_hall_f28379d_B.Max >= 75000000UL) {
  ...
  if (mcb_pmsm_foc_hall_f28379d_B.watchdogcheck != 0U) {
    ...
    /* Gain: '<S180>/SpeedGain' */
    mcb_pmsm_foc_hall_f28379d_B.SpeedGain = 0.0048697344F *
      mcb_pmsm_foc_hall_f28379d_B.Divide;
   ...
   */
  mcb_pmsm_foc_hall_f28379d_B.Switch_h = 0.17F;

  /* If: '<S214>/If' */
  if (mcb_pmsm_foc_hall_f28379d_B.Merge1 <= 0.17F) {
  ...
  mcb_pmsm_foc_hall_f28379d_B.PU_Conversion[0] = 0.0466666669F * Bias;
  ...
  /* Gain: '<S221>/PU_Conversion' */
  mcb_pmsm_foc_hall_f28379d_B.PU_Conversion[1] = 0.0466666669F * Bias;
