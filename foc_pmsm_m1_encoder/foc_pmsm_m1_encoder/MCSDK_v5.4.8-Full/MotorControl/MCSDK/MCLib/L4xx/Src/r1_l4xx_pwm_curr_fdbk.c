...
void R1L4XX_HFCurrentsCalibration( PWMC_Handle_t * pHdl, ab_t * pStator_Currents );
void R1L4XX_SetAOReferenceVoltage( uint32_t DAC_Channel, uint16_t hDACVref );
void R1L4XX_1ShuntMotorVarsInit( PWMC_Handle_t * pHdl );
void R1L4XX_1ShuntMotorVarsRestart( PWMC_Handle_t * pHdl );
void R1L4XX_TIMxInit( TIM_TypeDef * TIMx, PWMC_R1_L4_Handle_t * pHdl );
 ...
 * @retval none
 */
__weak void R1L4XX_Init( PWMC_R1_L4_Handle_t * pHandle )
{
  ...
  if ( TIMx == TIM1 )
  {
    ...
    LL_DMA_SetMemoryAddress( DMA1, LL_DMA_CHANNEL_6, ( uint32_t ) & ( pHandle->PreloadDisableActing ) );
  ...
  if ( COMP_OCPx )
  {
    ...
    if ( pHandle->pParams_str->CompOCPInvInput_MODE != EXT_MODE )
    {
      ...
      {
        R1L4XX_SetAOReferenceVoltage( LL_DAC_CHANNEL_1, ( uint16_t )( pHandle->pParams_str->DAC_OCP_Threshold ) );
      }
#if defined(DAC_CHANNEL2_SUPPORT)
      else if ( LL_COMP_GetInputMinus( COMP_OCPx ) == LL_COMP_INPUT_MINUS_DAC1_CH2 )
      {
        R1L4XX_SetAOReferenceVoltage( LL_DAC_CHANNEL_2, ( uint16_t )( pHandle->pParams_str->DAC_OCP_Threshold ) );
      }
#endif
      else
      {}
  ...
  if ( COMP_OVPx )
  {
    ...
    if ( pHandle->pParams_str->CompOCPInvInput_MODE != EXT_MODE )
    {
      ...
      {
        R1L4XX_SetAOReferenceVoltage( LL_DAC_CHANNEL_1, ( uint16_t )( pHandle->pParams_str->DAC_OVP_Threshold ) );
      }
#if defined(DAC_CHANNEL2_SUPPORT)
      else if ( LL_COMP_GetInputMinus( COMP_OVPx ) == LL_COMP_INPUT_MINUS_DAC1_CH2 )
      {
        R1L4XX_SetAOReferenceVoltage( LL_DAC_CHANNEL_2, ( uint16_t )( pHandle->pParams_str->DAC_OVP_Threshold ) );
      }
#endif
      else
      {}
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_TIMxInit( TIM_TypeDef * TIMx, PWMC_R1_L4_Handle_t * pHandle )
{
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_1ShuntMotorVarsInit( PWMC_Handle_t * pHdl )
{
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_1ShuntMotorVarsRestart( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_CurrentReadingCalibration( PWMC_Handle_t * pHdl )
{
...
/**
  ...
  */
__weak void R1L4XX_GetPhaseCurrents( PWMC_Handle_t * pHdl, ab_t * pStator_Currents )
{
  int32_t wAux;
  int16_t hCurrA = 0;
  int16_t hCurrB = 0;
...
/**
  ...
  */
__weak void R1L4XX_HFCurrentsCalibration( PWMC_Handle_t * pHdl, ab_t * pStator_Currents )
{
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_TurnOnLowSides( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_SwitchOnPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_SwitchOffPWM( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
  ADC_TypeDef * ADCx = pHandle->pParams_str->ADCx;
...
/**
  ...
  * @retval none
  */
__weak void * R1L4XX_TIMx_UP_IRQHandler( PWMC_R1_L4_Handle_t * pHandle )
{
...
/**
  ...
  * @retval none
  */
__weak void * R1L4XX_BRK2_IRQHandler( PWMC_R1_L4_Handle_t * pHandle )
{
...
/**
  ...
  * @retval none
  */
__weak void * R1L4XX_BRK_IRQHandler( PWMC_R1_L4_Handle_t * pHandle )
{
...
/**
  ...
  */
__weak uint16_t R1L4XX_IsOverCurrentOccurred( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
...
/**
  ...
  * @retval none
  */
__weak void R1L4XX_SetAOReferenceVoltage( uint32_t DAC_Channel, uint16_t hDACVref )
{
...
/**
  ...
  * @param  pHdl related object of class CPWMC
  ...
  */
__weak uint16_t R1L4XX_CalcDutyCycles( PWMC_Handle_t * pHdl )
{
  PWMC_R1_L4_Handle_t * pHandle = ( PWMC_R1_L4_Handle_t * )pHdl;
  TIM_TypeDef * TIMx = pHandle->pParams_str->TIMx;
