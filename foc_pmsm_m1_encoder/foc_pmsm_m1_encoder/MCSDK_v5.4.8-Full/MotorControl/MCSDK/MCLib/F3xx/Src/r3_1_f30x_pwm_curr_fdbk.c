/**
  ******************************************************************************
  * @file    r3_1_f3xx_pwm_curr_fdbk.c
...
/**
 * @defgroup R3_1_F30XX_pwm_curr_fdbk R3 2 ADCs F3 PWM & Current Feedback
 *
 * @brief STM32F3, 3-Shunt PWM & Current Feedback implementation
 *
