/**
  ******************************************************************************
  * @file    r3_2_f3xx_pwm_curr_fdbk.c
...
/**
 * @defgroup R3_2_H7XX_pwm_curr_fdbk R3 2 ADCs F3 PWM & Current Feedback
 *
 * @brief STM32H7, 3-Shunt PWM & Current Feedback implementation
 *
 * This component is used in applications based on an STM32H7 MCU, using a three
