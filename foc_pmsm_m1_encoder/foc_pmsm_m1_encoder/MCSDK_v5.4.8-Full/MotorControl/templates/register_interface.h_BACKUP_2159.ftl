...
#define  MC_REG_I_ALPHA_MEAS           ((33  << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define  MC_REG_I_BETA_MEAS            ((34  << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define  MC_REG_I_Q_MEAS               ((35  << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define  MC_REG_I_D_MEAS               ((36  << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
...
>>>>>>> origin/cr104575_ESC-G4-Stmcx-File-naming-update
...
#define  MC_REG_SPEED_RAMP            ((6  << ELT_IDENTIFIER_POS) | TYPE_DATA_RAW )
#define  MC_REG_TORQUE_RAMP           ((7  << ELT_IDENTIFIER_POS) | TYPE_DATA_RAW )
#define  MC_REG_REVUP_DATA            ((8  << ELT_IDENTIFIER_POS) | TYPE_DATA_RAW ) /* Configure all steps*/
